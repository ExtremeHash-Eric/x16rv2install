...
wget https://github.com/NextDesignSolutions/NextJtag/releases/download/v2.5/NextJtag-2.5.0-Linux-x86_64.tar.gz
...
nano ~/x16/NextJtag-2.5.0-Linux-x86_64/bin/nextjtag_license.txt
